    ...
    <>
      <div id="home">
        ...
        <section className="main-info">
          <p>
            After years of running both a successful preschool and a <a href="https://matteorusso.yoga">Yoga business</a>, I have started learning and practicing Frontend and Backend with online courses and 1:1 <a href="https://mentors.codingcoach.io/">mentorship</a>.
            I like to solve real challanges by building things through coding.
          ...
          <a className="linkToResume" href="https://drive.google.com/file/d/18cs11UYNIPhQUxcBN3SRUpQEnT-Pi_Xi/view?usp=drive_link">Download my Resume</a>
        </section>
